...
object SqlFailures {
     ...
     *
     * This is what a server older than MySQL 5.5.3 says to the modern driver's utf8mb4, and the
     * one failure worth retrying with the legacy driver. Anything else — a wrong password, an
     * unreachable host — would fail exactly the same way twice.
     */
